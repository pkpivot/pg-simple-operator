...
You deploy the controller in the same way that you deploy anything to Kubernetes; build an image and then run it in a Pod on the cluster. The `makefile` created by `kubebuilder` has tasks to simplify this for you. 
